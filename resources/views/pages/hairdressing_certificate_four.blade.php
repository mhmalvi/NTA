...
<title>SHB40216 - Certificate IV in Hairdressing</title>
@push('seo')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 page-content">
                <h1 style="color: #fff;">SHB40216 - Certificate IV in Hairdressing </h1>
            ...
            <div class="col-sm-8 course_detail wow fadeIn" data-wow-delay="400ms">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <br>
                        <p>Entry to this qualification is open to individuals who have:</p>
                        <p>1. achieved a Certificate III in Hairdressing (or equivalent); <strong>and</strong></p>
                        <p>2. at least one year post-qualification full time employment experience as a hairdresser in a salon environment where they have applied the skills and knowledge covered in the above (or equivalent) qualification.</p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>- 4 units from Group A</p>

                        <p>- 3 units from Group A or Group B</p>

                        <p>- 2 additional units from Group B, elsewhere in the SHB Training Package, or any other current Training Package or accredited course.</p>
