        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 course_detail wow fadeIn" data-wow-delay="400ms">
                    <img src="{{ asset('assets/images/courses/3.Certificate-III-in-Hairdressing.webp') }}" alt="Course"
                                        ...
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            {{-- <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                    ...
                                                    aria-controls="faqD"> --}}
                                                <h4 class="panel-title" role="button" data-toggle="collapse"
                                                data-parent="#accordion" href="#faqD" aria-expanded="false" aria-controls="faqD">
